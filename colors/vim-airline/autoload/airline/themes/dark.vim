...
" The dark.vim theme:
let s:airline_a_normal   = [ '#00005f' , '#00ffff' , 196  , 196 ]
let s:airline_b_normal   = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:airline_c_normal   = [ '#00ffff' , '#202020' , 85  , 234 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#000000' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#282C34',  '#61AFEF' , 17  , 45  ]
let s:airline_b_insert = s:airline_b_normal
let s:airline_c_insert = [ '#61AFEF',  '#202020' , 15  , 17  ]
...
let s:airline_a_visual = [ '#282C34',  '#C678DD' , 232 , 214 ]
let s:airline_b_visual = s:airline_b_normal
let s:airline_c_visual = [ '#C678DD',  '#202020' , 15  , 52  ]
...
let s:airline_a_commandline = [ '#00005f' , '#ABB2BF' , 17  , 40 ]
let s:airline_b_commandline = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:airline_c_commandline = [ '#ABB2BF' , '#202020' , 85  , 234 ]
